      ...
      <div className="max-w-xl w-full">
        <Card className="text-center p-8">
          ...
          <div className="bg-yellow-50 p-4 rounded-lg mb-6 text-left">
            <h4 className="font-semibold text-yellow-900 mb-2 text-sm">What Happened?</h4>
            <ul className="text-xs text-yellow-700 space-y-1">
              <li>• Payment was declined or cancelled</li>
              <li>• Insufficient funds or payment limit exceeded</li>
              <li>• Network or technical issue during payment</li>
            </ul>
          </div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-100">
            <p className="text-sm text-gray-500">
              Need assistance? <Link href="/contact" className="text-primary-600 font-semibold hover:underline">Contact Support</Link>
            </p>
          </div>
        </Card>
      </div>
