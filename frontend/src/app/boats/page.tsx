...
export default function BoatsPage() {
  ...
  useEffect(() => {
    const fetchBoats = async () => {
      try {
        ...
        if (res.data) {
          const mapped: Boat[] = res.data.map((b: any) => ({
            id: b.id ?? b._id,
            _id: b.id ?? b._id,
            name: b.name,
            ...
            totalRooms:
              ...
              (Array.isArray(b.rooms)
                ? b.rooms.reduce(
                    (sum: number, r: Room) => sum + (r.count || 0),
                    0
                  )
                : 7),
            images: b.images ?? [],
  ...
  const filteredBoats =
    filter === "all" ? boats : boats.filter((boat) => boat.type === filter);
      ...
      <section className="bg-gradient-hero text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-100 max-w-3xl mx-auto">
            Choose from our collection of luxury houseboats, each designed to
            provide the perfect blend of comfort, style, and adventure on the
            waters of Tanguar Haor.
          </p>
        </div>
      </section>
              ...
              <div className="relative h-72 bg-gray-200">
                ...
                <div className="absolute top-4 right-4">
                  <span
                    className={
                      boat.type === "AC"
                        ? "badge-gold shadow-gold"
                        : "badge-coral shadow-coral"
                    }
                  >
                    {boat.type}
                  </span>
                ...
                <div className="absolute top-4 left-4">
                  <span className="badge-primary shadow-primary">Premium</span>
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="mb-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                    <svg
                      className="w-5 h-5 mr-2 text-luxury-500"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
        ...
        {filteredBoats.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-xl text-gray-600">
              No boats found matching your filter.
            </p>
          </div>
        )}
      </section>
      ...
      <section className="bg-gradient-hero py-16 text-white text-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button href="/packages" size="lg" variant="outlineSecondary">
              View Packages
            </Button>
          </div>
        </div>
