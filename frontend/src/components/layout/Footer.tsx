    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Contact & Legal */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-primary-400">Contact & Legal</h4>
            <div className="space-y-3 mb-4">
              ...
              <p className="text-gray-400 text-sm flex items-start">
                ...
                <span>info@westboundtravels.com</span>
              </p>
            </div>
            <ul className="space-y-2">
              {legalLinks.map((link) => (
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <p className="text-center text-gray-400 text-sm">
            © {new Date().getFullYear()} West Bound Travels. All rights reserved. | Developed by{' '}
            <a 
              href="http://moniruzzaman-mahdi.vercel.app" 
              target="_blank" 
