...
export default function FeaturedBoats() {
  ...
  useEffect(() => {
    const fetchBoats = async () => {
      try {
        ...
        if (res.data) setBoats(res.data);
      } catch (err) {
        console.error('Failed to fetch featured boats:', err);
      } finally {
        setLoading(false);
      }
    };
  ...
  const featuredBoats = boats.slice(0, 4);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Choose from our collection of luxury houseboats, each offering
            unique experiences and premium amenities for your perfect journey.
          </p>
        </div>
                ...
                <div className="p-6">
                  ...
                  <div className="border-t border-luxury-200 pt-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {boat.rooms && Array.isArray(boat.rooms) && boat.rooms.slice(0, 2).map((room, idx) => (
                        <span
                          key={idx}
                      ...
                      {boat.rooms && boat.rooms.length > 2 && (
